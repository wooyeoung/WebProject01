...
<div class="login_wrap">
   <table class="login_form" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
         <td align="center">
            <form action="/board/filterOrderOnlyThisLogin.me" method="post" id="loginform">
                        ...
                        <div style="line-height: 2;">
                           <a href="/board/loginPage/memberJoin.jsp" id="style2"
                              style="font-family: 'Nanum Gothic', sans-serif; text-decoration: none; vertical-align:middle;
                                    display: inline-block; width: 300px; height:48px;">
                                 회원가입
                           </a>
                        </div>
                     </td>
...
function action(){
   loginform.action = '/board/filterOrderOnlyThisLogin.me';
