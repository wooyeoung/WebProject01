...
<div id="member_all_wrap">
		...
		<div id="order_wrap">
			<div class="member_name" style="margin-left: 100px;">
				<h3>${review.name} 리뷰 수정</h3>
			</div>
			
			<div class="under_line"></div>
				<form name="reviewform" action="/board/updateReview.re" method="post" enctype="multipart/form-data">
					<table  class="inquiry_table" id="member_table" cellpadding="0" cellspacing="0">
						<tr>
							<th>상품 이름</th>
							<td colspan="2">
								<input type="text" name="name" value="${review.name} " style="border-style: none;" readonly>
							</td>
						</tr>
						<tr>
							<th>작성자</th>
						...
						<tr>
							...
							<img src="../ReviewUpload/${review.image }" width="300" height="200"/><br><br>
    							<input type="file" id="image01" name="file01" size="1"><br><br>
						...
						<tr>
							<td colspan="3" id="lasttag">
								<input  class="chk_btn" value="리뷰 수정" type="submit"/>
							</td>
